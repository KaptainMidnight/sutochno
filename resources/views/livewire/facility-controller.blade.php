<div>
    ...
    <livewire:facility-filter-component/>
                    ...
                    <div class="bg-white shadow-xl rounded-lg overflow-hidden">
                        <a href="{{ route('facility.show', $facility['id']) }}">
                            <div class="bg-cover bg-center h-56 p-4"
                                ...
                                <div class="flex justify-end cursor-pointer" wire:click="setFavorite({{ $facility['id'] }})">
                        ...
                        <div class="p-4">
                            <p class="uppercase tracking-wide text-sm font-bold text-gray-700">{{ \Illuminate\Support\Str::words($facility['title'], 3) }}
                                • {{ \Illuminate\Support\Carbon::parse($facility['created_at'])->diffForHumans() }}</p>
                        ...
                        <div class="flex p-4 border-t border-gray-300 text-gray-700">
                            <div class="flex-1 inline-flex items-center">
                                ...
                                <p><span class="text-gray-900 font-bold">{{ $facility['beds'] }}</span> Bedrooms</p>
                            </div>
                            <div class="flex-1 inline-flex items-center">
                                <svg class="h-6 w-6 text-gray-600 fill-current mr-3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                ...
                                <p><span class="text-gray-900 font-bold">{{ $facility['bathrooms'] }}</span> Bathrooms</p>
                            </div>
                        </div>
                        <div class="px-4 pt-3 pb-4 border-t border-gray-300 bg-gray-100">
                            ...
                            <div class="flex items-center pt-2">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-700">{{ $facility['user']['phone'] }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
